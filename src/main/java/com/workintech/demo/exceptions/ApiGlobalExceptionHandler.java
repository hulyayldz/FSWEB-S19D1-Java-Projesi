...
public class ApiGlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleException(ApiException apiException) {
        ExceptionResponse exceptionResponse = new ExceptionResponse("apiException(custom) occured: " + apiException.getMessage(), apiException.getHttpStatus().value(), LocalDateTime.now());
